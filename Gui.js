window.getBlooketReactOwner = function() {
    try {
        ...
        for (let i = 0; i < allDivs.length; i++) {
            ...
            if (reactKey && node[reactKey]) {
                ...
                while(fiber) {
                    if (fiber.memoizedProps && (fiber.memoizedProps.client || fiber.memoizedProps.liveGameController)) {
                        return { stateNode: { props: fiber.memoizedProps, state: fiber.memoizedState || {} }, props: fiber.memoizedProps, state: fiber.memoizedState || {} };
                    }
                    if (fiber.stateNode) {
                        if (fiber.stateNode.props && (fiber.stateNode.props.client || fiber.stateNode.props.liveGameController)) {
                            return fiber;
                        }
                        if (fiber.stateNode.state && fiber.stateNode.state.question) {
                            return fiber;
                        }
                    }
                    fiber = fiber.return;
    ...
    try {
        let node = Object.values(document.querySelector('#app>div>div') || {})[1]?.children?.[0]?._owner;
        if (node) return node;
    } catch(e) {}

    return { stateNode: { props: { client: { question: { correctAnswers: [] } }, liveGameController: { setVal: ()=>{}, removeVal: ()=>{}, getDatabaseVal: ()=>Promise.resolve() } }, state: { question: { correctAnswers: [] } } }, props: { client: { question: { correctAnswers: [] } } } };
};
...
(async () => {
    ...
    let C = {
        global: [{
            ...
            run: function(e) {
                let t = window.getBlooketReactOwner().stateNode;
            ...
            run: function() {
                window.getBlooketReactOwner().stateNode.setState({
                        isRandom: !1,
                        client: {
                            name: ""
                        }
        ...
        brawl: [{
            ...
            run: function() {
                for (let e of window.getBlooketReactOwner().stateNode.game.current.scene.scenes[0].physics.world.colliders._active.filter(e => e.callbackContext?.toString().includes("invulnerableTime"))) {
                    var t = e.object2;
            ...
            run: function() {
                window.getBlooketReactOwner().stateNode.game.current.scene.scenes[0].physics.world.colliders._active.find(e => e.collideCallback?.toString().includes("magnetTime")).collideCallback({
                    active: !0
                }, {
                    active: !0,
                    setActive() {},
            ...
            run: function() {
                let e = window.getBlooketReactOwner().stateNode;
            ...
            run: function() {
                window.getBlooketReactOwner().stateNode.game.current.scene.scenes[0].physics.world.bodies.entries.forEach(e => {
                    try {
            ...
            run: function() {
                window.getBlooketReactOwner().stateNode.game.current.scene.scenes[0].physics.world.bodies.entries.forEach(e => e?.gameObject?.receiveDamage?.(e.gameObject.hp, 1))
            }
        }, {
            name: "Reset Health",
            description: "Resets health and gives invincibility for 3 seconds",
            run: function() {
                window.getBlooketReactOwner().stateNode.game.current.scene.scenes[0].game.events._events.respawn.fn()
            }
        }, {
            ...
            run: function(e) {
                var t = window.getBlooketReactOwner().stateNode;
                t.setState({
                        xp: e,
                        totalXp: e
                    }),
        ...
        cafe: [{
            ...
            run: function() {
                ...
                document.body.append(e),
                    window.alert = e.contentWindow.alert.bind(window),
                    e.remove(),
                    "/cafe/shop" !== window.location.pathname ? alert("This can only be run in the shop") : (e = window.getBlooketReactOwner().stateNode).setState({
            ...
            run: function() {
                ...
                document.body.append(e),
                    window.alert = e.contentWindow.alert.bind(window),
                    e.remove(),
                    "/cafe" !== window.location.pathname ? alert("This can't be run in the shop") : (e = window.getBlooketReactOwner().stateNode).setState({
        ...
        crypto: [{
            ...
            data: null,
            run: function() {
                this.enabled ? (this.enabled = !1, clearInterval(this.data), this.data = null) : (this.enabled = !0, this.data = setInterval(() => window.getBlooketReactOwner().stateNode.setState({
                    choices: [{
                        type: "mult",
                        val: 3,
                        rate: .075,
                    ...
                    e.enabled ? (e.enabled = !1, clearInterval(e.data), e.data = null) : (e.enabled = !0, e.data = setInterval(() => {
                        if ("hack" === ("hack" === window.location.pathname.split("/")[2] && "hack")) {
                            let {
                                stage: e,
                                correctPassword: t
                            } = window.getBlooketReactOwner().stateNode.state;
            ...
            data: null,
            run: function() {
                var a = window.getBlooketReactOwner().stateNode;
        ...
        defense: [{
            ...
            run: function() {
                window.getBlooketReactOwner().stateNode.towers.forEach(e => {
                    e.range = 100,
                        e.fullCd = e.cd = 0,
                        e.damage = 1e6
                })
            ...
            run: function() {
                for (var i = 0; i < 10; i++) {
                    window.getBlooketReactOwner().stateNode.tiles[i] = Array(10).fill(0);
                }
            }
        }, {
            name: "Remove Enemies",
            ...
            run: function(e) {
                window.getBlooketReactOwner().stateNode.dmg = e
            }
        }, {
            name: "Set Round",
        ...
        defense2: [{
            ...
            description: "Makes all placed towers overpowered",
            run: function() {
                window.getBlooketReactOwner().stateNode.state.towers.forEach(e => {
        ...
        doom: [{
            ...
            run: function() {
                ...
                document.body.append(e),
                    window.alert = e.contentWindow.alert.bind(window),
                    e.remove(),
                    "/tower/map" == window.location.pathname ? (e = window.getBlooketReactOwner().stateNode).props.tower.cards.forEach(e => {
                        e.strength = 20,
                            e.charisma = 20,
                            e.wisdom = 20
                    }) : alert("You need to be on the map to run this cheat!")
            ...
            run: function() {
                ...
                document.body.append(e),
                    window.alert = e.contentWindow.alert.bind(window),
                    e.remove(),
                    "/tower/battle" == window.location.pathname ? window.getBlooketReactOwner().stateNode.setState({
                        myHealth: 100
            ...
            run: function() {
                var e = document.createElement("iframe"),
                    e = (document.body.append(e), window.alert = e.contentWindow.alert.bind(window), e.remove(), window.getBlooketReactOwner()).stateNode;
            ...
            run: function(e) {
                ...
                if (document.body.append(t), window.alert = t.contentWindow.prompt.bind(window), t.remove(), "/tower/battle" == window.location.pathname) {
                    var t = parseInt("0" + alert("How many coins would you like?")),
                        a = window.getBlooketReactOwner().stateNode;
                    try {
        ...
        factory: [{
            ...
            run: function() {
                window.getBlooketReactOwner().stateNode.setState(e => ({
                    ...e,
            ...
            run: function() {
                window.getBlooketReactOwner().stateNode.state.blooks.forEach(e => e.level = 4)
            }
        }, {
        ...
        fishing: [{
            ...
            enabled: !1,
            run: function() {
                const componentInstance = window.getBlooketReactOwner().stateNode;
                if (this.enabled) {
                    this.enabled = !1;
            ...
            run: function(e) {
                var t = document.createElement("iframe"),
                    t = (document.body.append(t), window.alert = t.contentWindow.alert.bind(window), t.remove(), window.getBlooketReactOwner()).stateNode;
                t.safe = !0,
                    t.props.liveGameController.setVal({
                        path: "c/" + t.props.client.name,
                        val: {
        ...
        gold: [{
            ...
            run: (player, amount) => {
                const sn = window.getBlooketReactOwner().stateNode;
        ...
        kingdom: [{
            ...
            run: function() {
                window.getBlooketReactOwner().stateNode.taxCounter = Number.MAX_VALUE
            }
        }, {
            name: "Max Stats",
            ...
            run: function() {
                window.getBlooketReactOwner().stateNode.nextGuest()
            }
        }],
        racing: [{
            name: "Instant Win",
        ...
        host: [{
            ...
            run: function() {
                ...
                this.data = setInterval(async () => {
                    ...
                    try {
                        let stateNode = window.getBlooketReactOwner().stateNode;
        ...
        rush: [{
            ...
            run: function(e) {
                var e = Math.min(e, 4),
                    t = window.getBlooketReactOwner().stateNode;
                t.setState({
                        numDefense: e
                    }),
                    t.isTeam ? t.props.liveGameController.setVal({
        ...
        settings: [{
            name: "Toggle Debug Viewer",
            description: "Show captured console logs in the GUI",
            run: () => {
                let existing = document.getElementById('blooket-gui-debugger-container');
                if (existing) {
                    existing.style.display = existing.style.display === 'none' ? 'block' : 'none';
                    return;
                }
                const div = document.createElement('div');
                div.id = 'blooket-gui-debugger-container';
                ...
                title.innerText = 'GUI Debug Logs (Console Hijacked)';
                ...
                text.id = 'blooket-gui-debugger';
                text.style.width = '100%';
                text.style.height = 'calc(100% - 35px)';
                ...
                text.readOnly = true;
                text.value = window._capturedLogs.join('\n');
        ...
        alerts: [{
            ...
            getGamemode() {
                if (window.getBlooketReactOwner().stateNode.props?.client?.type) {
                    return window.getBlooketReactOwner().stateNode.props.client.type.toLowerCase();
                }
